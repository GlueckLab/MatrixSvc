...
/**
 * TestCases for Matrix Vec Operation.
 * @author VIJAY AKULA.
 *
 */
public class MatrixVecOperationTestCases extends TestCase
{
    ...
    private static String DATA_FILE = "data" + File.separator + "Vec Operation Data.xml";
    private static final String OUTPUT_FILE = "Reports"+ File.separator + "Vec Matrix Operation Results.html";
    private static final String TITLE = "Matrix Vec Operation Results";
    ...
    public void testVecOperation()
    {
        ...
        try
        {
            ...
            for(int i = 0; i < nodes.getLength(); i++)
            {
                ...
                Node m2r6c0 = attrs.getNamedItem("m2r6c0");
                Node m2r7c0 = attrs.getNamedItem("m2r7c0");
                Node m2r8c0 = attrs.getNamedItem("m2r8c0");
                ...
                data[6][0] = Double.parseDouble(m2r6c0.getNodeValue());
                
                data[7][0] = Double.parseDouble(m2r7c0.getNodeValue());
                
                data[8][0] = Double.parseDouble(m2r8c0.getNodeValue());
                ...
                assertEquals(data[6][0], resultData[6][0], 0.00000000001);
                assertEquals(data[7][0], resultData[7][0], 0.00000000001);
                assertEquals(data[8][0], resultData[8][0], 0.00000000001);
    ...
    public void outputResults(String title, String filename, String imageFilename)
    {
        ...
        for(int i = 0; i < resultMatrixList.size(); i++)
        {
            ...
            double value7 = Double.parseDouble(m2r6c0.getNodeValue().trim());
            double value8 = Double.parseDouble(m2r7c0.getNodeValue().trim());
            double value9 = Double.parseDouble(m2r8c0.getNodeValue().trim());
            ...
            if(Math.abs(value1-data[0][0])<0.00000000001 && Math.abs(value2-data[1][0])<0.00000000001 && Math.abs(value3-data[2][0])<0.00000000001
                    ...
                    && Math.abs(value7-data[6][0])<0.00000000001 && Math.abs(value8-data[7][0])<0.00000000001 && Math.abs(value9-data[8][0])<0.00000000001)
            {
