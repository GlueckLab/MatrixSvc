...
public class MatrixElementwiseMultiplicationTestCases extends TestCase
{
    ...
    private static final String DATA_FILE = "data" + File.separator + "Elementwise Multiplication Data.xml";
    private static final String OUTPUT_FILE = "Reports"+ File.separator + "Elementwise Multiplication Results.html";
    private static final String TITLE = "Elementwise Multiplication Results";
    ...
    public void testValidElementwiseMultiplication()
    {
        ...
        try
        {
            ...
            for(int i = 0; i < nodes.getLength(); i++)
            {
                ...
                MatrixElementwiseMultiplicationServerResource resource = new MatrixElementwiseMultiplicationServerResource();
