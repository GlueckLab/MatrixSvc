...
/**
 * TestCase for Matrix Addition operation.
 * @author VIJAY AKULA
 *
 */
public class MatrixAdditionTestCases extends TestCase
{   
    ...
    private static final String DATA_FILE = "data" + File.separator + "Addition Data.xml";
    private static final String OUTPUT_FILE = "Reports"+ File.separator + "Addition Results.html";
    private static final String TITLE = "Addition Results";
