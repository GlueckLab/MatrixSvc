 ...
 */
public class MatrixHorizontalDirectMultiplicationResource extends ServerResource
{
	private static Logger logger = MatrixLogger.getInstance();
	
    /**
     * Handle POST request to perform the horizontal direct product of a list of matrices
     * @param entity XMl formatted matrix list
     * @return XML representation of the horizontal direct product
     * @throws ResourceException
     */
	@Post
    public Representation matrixHorizontalDirectMultiplication (Representation entity) throws ResourceException
    {
		if(entity == null)
		{
